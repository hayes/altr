...
test('destroy directive', function(t) {
  altr.addDirective('destroy', destroy)
...
test('nested for destroy directive', function(t) {
  altr.addDirective('nested-destroy', destroy)
