...
!function(t){function e(o,r,i,n){if(!(this instanceof e))return new e(o,r,i,n);if(this.root=o,this.sync=i,this.batch=v(i),this.document=n||t.document,this.filters=Object.create(e.filters),this.includes=Object.create(e.includes),this.accessors=y(this.filters,!1),t.Buffer&&o instanceof t.Buffer&&(o=o.toString()),"string"==typeof o){var s=this.document.createElement("div");for(s.innerHTML=o,this.root=this.document.createDocumentFragment();s.firstChild;)this.root.appendChild(s.firstChild)}this._update=this.updateNodes(this.rootNodes()),r&&this.update(r)}function o(t){this._update(t),this.sync&&this.batch.run()}function r(t){function e(t){for(var e=0,i=o.length;i>e;++e)o[e].call(r,t)}var o=this.initNodes(t),r=this;return e}function i(t){function e(t,e){return t.concat(e)}var o=[].slice.call(t).map(n.bind(this)).filter(Boolean).reduce(e,[]);return o}function n(t){return q[t.nodeType]?q[t.nodeType].call(this,t):t.childNodes&&t.childNodes.length?this.initNodes(t.childNodes):null}function s(){return 11===this.root.nodeType?[].slice.call(this.root.childNodes):[this.root]}function c(t,o){e.filters[t]=o}function d(t,o){e.prototype.tags[t]=o,e.prototype.tagList.push({attr:t,constructor:o})}function u(){return this.rootNodes().map(function(t){return t.outerHTML}).join("")}function p(t){for(var e=this.rootNodes(),o=0,r=e.length;r>o;++o)t.appendChild(m(e[o]))}function a(t,e){return this.includes[t]=e}function l(t,e){return this.accessors.create(t,e,!1)}function c(t,e){return this.filters[t]=e}var h=require("./template_string"),f=require("./element_node"),y=require("altr-accessors"),g=require("./text_node"),m=require("./get_element"),N=require("./render"),v=require("./batch");e.filters={},e.includes={},e.render=N,module.exports=e,e.addTag=d,e.include=a,e.addFilter=c,e.prototype.templateString=h,e.prototype.createAccessor=l,e.prototype.updateNodes=r,e.prototype.initNodes=i,e.prototype.rootNodes=s,e.prototype.addFilter=c,e.prototype.toString=u,e.prototype.include=a,e.prototype.initNode=n,e.prototype.getElement=m,e.prototype.into=p,e.prototype.update=o,e.prototype.tagList=[],e.prototype.tags={};var q={};q[1]=f,q[3]=g}.call(this,"undefined"!=typeof self?self:"undefined"!=typeof window?window:{});
...
function render(e,n){this.includes[e]&&(e=this.includes[e]);var r=this(e);return n&&(n.innerHTML="",r.into(n)),r}module.exports=render;
},{}],8:[function(require,module,exports){
function set_children(e,r){for(var t,i=null,l=r.length-1;l>=0;--l)t=get(r[l]),(i&&t.nextSibling!==i||e.lastChild!==t)&&e.insertBefore(t,i),i=t;for(;e.firstChild!==i;)e.removeChild(e.firstChild)}var get=require("./get_element");module.exports=set_children;
},{"./get_element":5}],9:[function(require,module,exports){
function children(e,r){function n(r){var n=Array.isArray(r)?r:[r];set_children(e,n.filter(is_node))}return this.batch.add(this.createAccessor(r,n))}function is_node(e){return e&&e.nodeType}var set_children=require("../set_children");module.exports=children;
},{"../set_children":8}],10:[function(require,module,exports){
function for_handler(e,r){function n(e){for(var r,n=0,t=l.length;t>n;++n)r=Object.create(e),r[p]=u[n],r.$index=n,l[n].update&&l[n].update(r)}function t(e,r){Array.isArray(e)||(e=[]);var t,o=new Array(e.length);s=[];for(var c=0,d=e.length;d>c;++c)t=i(u,e[c],h),-1!==t?(o[c]=l.splice(t,1)[0],u.splice(t,1)):o[c]=a(),s=s.concat(o[c].dom_nodes);l=o.slice(),u=e.slice(),_(),n(r)}function i(e,r,n){if(!n)return e.indexOf(r);for(var t=0,i=e.length;i>t;++t)if(e[t][n]===r[n])return t;return-1}function a(){var r,n,t=f.document.createElementNS(e.namespaceURI,"div");return t.innerHTML=d,r=Array.prototype.slice.call(t.childNodes),n=f.updateNodes(r),{dom_nodes:r,update:n}}function o(){set_children(e,s)}var c=r.match(for_regexp),d=e.innerHTML,s=[],l=[],f=this,u=[];if(!c)throw new Error("invalid for tag: "+r);e.innerHTML="";var h=c[1].split(":")[1],p=c[1].split(":")[0],v=c[2],_=this.batch.add(o);return f.createAccessor(v,t)}var set_children=require("../set_children"),for_regexp=/^(.*?)\s+in\s+(.*$)/;module.exports=for_handler;
