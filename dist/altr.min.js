...
(function (global){
function altr(t,e,r){if(!(this instanceof altr))return new altr(t,e,r);var r=r||{};if(this.filters=extend(!1,Object.create(altr.filters),r.filters||{}),this.decorators=extend(!1,Object.create(altr.decorators),r.decorators||{}),this.includes=extend(!1,Object.create(altr.includes),r.includes||{}),this.root=t,this.sync=!!r.sync,this.tagRegExp=makeTagRegExp(r.delimiters),this.document=r.doc||global.document||require(domModule).document,this.lookups=dirtybit(e,{filters:this.filters}),this.batch=batch(function(){this.sync||raf(this.runBatch.bind(this))}.bind(this)),global.Buffer&&t instanceof global.Buffer&&(t=t.toString()),"string"==typeof t){var o=this.document.createElement("div");for(o.innerHTML=t,this.root=this.document.createDocumentFragment();o.firstChild;)this.root.appendChild(o.firstChild)}this.children=this.initNodes(this.rootNodes(),this.lookups),this.runHooks(this.children.hooks,"insert",null),this.runBatch()}function update(t,e){this.state=t,this.lookups.update(t),(e||this.sync)&&this.runBatch()}function initNodes(t,e,r){function o(t,e){var r=initNode.call(i,n,e);return r?t.concat(r):t}var i=this,n=e||dirtybit(r,{filters:this.filters}),a=Array.prototype.slice.call(t),d=a.reduce(o,[]).filter(Boolean);return{hooks:d,lookups:n,nodes:a}}function initNode(t,e){return node_handlers[e.nodeType]?node_handlers[e.nodeType].call(this,e,t):e.childNodes&&e.childNodes.length?this.initNodes(t,e.childNodes):null}function rootNodes(){return this.root.nodeType===this.document.DOCUMENT_FRAGMENT_NODE?[].slice.call(this.root.childNodes):[this.root]}function addFilter(t,e){this.filters[t]=e}function addTag(t,e){this.prototype.tags[t]=e,this.prototype.tagList.push({attr:t,constructor:e})}function appendTo(t){for(var e=this.rootNodes(),r=0,o=e.length;o>r;++r)t.appendChild(getEl(e[r]))}function include(t,e){return this.includes[t]=e}function addFilter(t,e){return this.filters[t]=e}function addDecorator(t,e){return this.decorators[t]=e}function runBatch(){this.batch.run()&&this.emit("update",this.state)}function makeTagRegExp(t){var e=t||["{{","}}"];return new RegExp(e[0]+"\\s*(.*?)\\s*"+e[1])}var EE=require("events").EventEmitter,batch=require("batch-queue"),dirtybit=require("dirtybit"),extend=require("extend"),templateString=require("./template-string"),elementNode=require("./element-node"),mergeHooks=require("./merge-hooks"),altrExtend=require("./altr-extend"),textNode=require("./text-node"),toString=require("./to-string"),runHooks=require("./run-hooks"),getEl=require("./get-element"),destroy=require("./destroy"),render=require("./render"),remove=require("./remove"),raf=require("./raf"),domModule="micro-dom";module.exports=altr,altr.filters={},altr.includes={},altr.decorators={},altr.render=render,altr.addTag=addTag,altr.include=include,altr.extend=altrExtend,altr.addFilter=addFilter,altr.addDecorator=addDecorator,altr.prototype=Object.create(EE.prototype),altr.prototype.constructor=altr,altr.prototype.templateString=templateString,altr.prototype.addDecorator=addDecorator,altr.prototype.mergeHooks=mergeHooks,altr.prototype.initNodes=initNodes,altr.prototype.rootNodes=rootNodes,altr.prototype.addFilter=addFilter,altr.prototype.runBatch=runBatch,altr.prototype.toString=toString,altr.prototype.runHooks=runHooks,altr.prototype.getElement=getEl,altr.prototype.include=include,altr.prototype.destroy=destroy,altr.prototype.remove=remove,altr.prototype.into=appendTo,altr.prototype.update=update,altr.prototype.tagList=[],altr.prototype.tags={};var node_handlers={};node_handlers[1]=elementNode,node_handlers[3]=textNode;
//# sourceMappingURL=altr.min.map
...
function include(n,e,i){function t(){r||(n.innerHTML=c.includes[e],r=c.initNodes(n.childNodes,null,i.state))}function o(n,e){r&&!l&&(r=null,l=!0,c.destroy(r,n,function(){l=!1,r||(n.innerHTML=""),e()}))}function u(n){r&&r.lookups.update(n)}function s(){i.removeListener("this",u)}var l=!1,r=null,c=this;return i.on("this",u),{insert:t,remove:o,destroy:s}}module.exports=include;
//# sourceMappingURL=altr.min.map
