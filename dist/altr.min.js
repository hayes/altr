...
!function(t){function e(o,i,r,n){if(!(this instanceof e))return new e(o,i,r,n);if(this.root=o,this.sync=r,this.batch=N(r),this.document=n||t.document,this.filters=Object.create(this.filters),this.includes=Object.create(this.includes),this.accessors=y(this.filters,!1),t.Buffer&&o instanceof t.Buffer&&(o=o.toString()),"string"==typeof o){var s=this.document.createElement("div");for(s.innerHTML=o,this.root=this.document.createDocumentFragment();s.firstChild;)this.root.appendChild(s.firstChild)}this._update=this.updateNodes(this.rootNodes()),i&&this.update(i)}function o(t){this._update(t),this.sync&&this.batch.run()}function i(t){function e(t){for(var e=0,r=o.length;r>e;++e)o[e].call(i,t)}var o=this.initNodes(t),i=this;return e}function r(t){function e(t,e){return t.concat(e)}var o=[].slice.call(t).map(n.bind(this)).filter(Boolean).reduce(e,[]);return o}function n(t){return m[t.nodeType]?m[t.nodeType].call(this,t):t.childNodes&&t.childNodes.length?this.initNodes(t.childNodes):null}function s(){return 11===this.root.nodeType?[].slice.call(this.root.childNodes):[this.root]}function c(t,o){e.prototype.filters[t]=o}function d(t,o){e.prototype.tags[t]=o,e.prototype.tagList.push({attr:t,constructor:o})}function p(){return this.rootNodes().map(function(t){return t.outerHTML}).join("")}function u(t){for(var e=this.rootNodes(),o=0,i=e.length;i>o;++o)t.appendChild(e[o])}function a(t,e){return this.includes[t]=e}function h(t,e){return this.accessors.create(t,e,!1)}function c(t,e){return this.filters[t]=e}var l=require("./template_string"),f=require("./element_node"),y=require("altr-accessors"),g=require("./text_node"),N=require("./batch");module.exports=e,e.addTag=d,e.include=a.bind(e.prototype),e.addFilter=c.bind(e.prototype),e.prototype.templateString=l,e.prototype.createAccessor=h,e.prototype.updateNodes=i,e.prototype.addFilter=c,e.prototype.initNodes=r,e.prototype.rootNodes=s,e.prototype.toString=p,e.prototype.include=a,e.prototype.initNode=n,e.prototype.into=u,e.prototype.update=o,e.prototype.includes={},e.prototype.tagList=[],e.prototype.filters={},e.prototype.tags={};var m={};m[1]=f,m[3]=g}.call(this,"undefined"!=typeof self?self:"undefined"!=typeof window?window:{});
...
function for_handler(e,r){function n(e){for(var r,n=0,t=f.length;t>n;++n)r=Object.create(e),r[v]=h[n],r.$index=n,f[n].update&&f[n].update(r)}function t(r,t){function a(e,r){l.push({insert:e,before:r})}Array.isArray(r)||(r=[]);for(var s,d,c=new Array(r.length),v=e.firstChild,m=0,g=0,_=r.length;_>g;++g)s=o(h,r[g],u),-1!==s?(c[g]=f.splice(s,1)[0],h.splice(s,1),s+m!==g&&a(c[g].dom_nodes,v)):(c[g]=i(),a(c[g].dom_nodes,v)),++m,d=c[g].dom_nodes,v=d.length?d[d.length-1].nextSibling:null,d=d.concat(c[g].dom_nodes);for(var g=0,_=f.length;_>g;++g)l.push({remove:f[g].dom_nodes});f=c.slice(),h=r.slice(),p(),n(t)}function o(e,r,n){if(!n)return e.indexOf(r);for(var t=0,o=e.length;o>t;++t)if(e[t][n]===r[n])return t;return-1}function i(){var r,n,t=c.document.createElementNS(e.namespaceURI,"div");return t.innerHTML=d,r=Array.prototype.slice.call(t.childNodes),n=c.updateNodes(r),{dom_nodes:r,update:n}}function a(){for(var r,n=0,t=l.length;t>n;++n){if(r=l[n],r.remove)for(var o=0,i=r.remove.length;i>o;++o)e.removeChild(r.remove[o]);if(r.insert)for(var o=0,i=r.insert.length;i>o;++o)e.insertBefore(r.insert[o],r.before)}l=[]}var s=r.match(for_regexp),d=e.innerHTML,l=[],f=[],c=this,h=[];if(!s)throw new Error("invalid for tag: "+r);e.innerHTML="";var u=s[1].split(":")[1],v=s[1].split(":")[0],m=s[2],p=this.batch.add(a);return c.createAccessor(m,t)}var for_regexp=/^(.*?)\s+in\s+(.*$)/;module.exports=for_handler;
},{}],7:[function(require,module,exports){
function html(e,t){function r(t){e.innerHTML="undefined"==typeof t?"":t,e.getAttribute("altr-run-scripts")&&[].forEach.call(e.getElementsByTagName("script"),run)}return this.batch.add(this.createAccessor(t,r))}function run(e){for(var t=document.createElement("script"),r=e.parentNode,n=e.attributes,i=0,a=n.length;a>i;++i)t.setAttribute(n[i].name,n[i].value);t.innerHTML=e.innerHTML,r.insertBefore(t,e),r.removeChild(e)}module.exports=html;
},{}],8:[function(require,module,exports){
function if_tag(e,t){function i(e,t){return e?(c(),r(t),void 0):d()}var n=this.document.createComment("altr-if-placeholder"),r=this.updateNodes(e.childNodes),o=e.parentNode,a=null;o.insertBefore(n,e.nextSibling);var d=this.batch.add(function(){a||(o.removeChild(e),a=!0)}),c=this.batch.add(function(){a&&(o.insertBefore(e,n),a=!1)});return this.createAccessor(t,i)}module.exports=if_tag;
},{}],9:[function(require,module,exports){
function include(e,d){return e.innerHTML=this.includes[d],this.updateNodes(e.childNodes)}module.exports=include;
},{}],10:[function(require,module,exports){
function placeholder(e,r){function o(r){r.nodeName&&(t.insertBefore(r,e),t.removeChild(e),e=r)}var t=e.parentNode;return this.batch.add(this.createAccessor(r,o))}module.exports=placeholder;
