...
function add_type(e,r){accessor_types.push({test:RegExp.prototype.test.bind(e),create:r})}function accessor(e,r){function t(e,t,a){return e||(s=a||t),e===c.length?r.call(this,t,s):(c[e](t,s),void 0)}for(var s,c=e.split("|"),a=0,n=c.length;n>a;++a)c[a]=build_part.call(this,c[a],t.bind(this,a+1));return t.bind(this,0)}function build_part(e,r){for(var t=0,s=accessor_types.length;s>t;++t)if(accessor_types[t].test(e))return accessor_types[t].create.call(this,e,r)}function create_lookup(e,r){return e.indexOf("$data")||(e=e.slice("$data.".length)),lookup(e.match(/\s*(.*[^\s])\s*/)[1],r)}function create_filter(e,r){var t=e.match(filter_regexp),s=this.filters[t[1]];if(!s)throw new Error("could not find filter: "+t[1]);return s.call(this,t[2],r)}function create_string_accessor(e,r){var t=e.match(string_regexp);return e=t[1]||t[2],function(){r(e)}}function create_number_accessor(e,r){var t=e.match(number_regexp);return e=+t[1],function(){r(e)}}function create_ternary(e,r){function t(e,r){e?c(r):s(r)}e=e.match(ternary_regexp);var s=accessor(e[3],r),c=accessor(e[2],r);return accessor(e[1],t)}function create_equals(e,r){function t(e){c(e),a(e)}function s(t,s){t?o=s:n=s,r(2===e[2].length?n==o:n===o)}e=e.match(equals_regexp);var c=accessor(e[1],s.bind(null,!1)),a=accessor(e[3],s.bind(null,!0)),n={},o={};return t}var lookup=require("./lookup"),accessor_types=[],string_regexp=/^\s*(?:'((?:[^'\\]|(?:\\.))*)'|"((?:[^"\\]|(?:\\.))*)")\s*/,ternary_regexp=/^\s*([^\?]+)\?([^\?:]+):(.*)\s*$/,equals_regexp=/^\s*([^=]+)(={2,3})(.*)\s*$/,filter_regexp=/^\s*([^(]+)\((.*)\)\s*$/,number_regexp=/^\s*(\d*(?:\.\d+)?)\s*$/;module.exports=accessor,add_type(ternary_regexp,create_ternary),add_type(equals_regexp,create_equals),add_type(filter_regexp,create_filter),add_type(string_regexp,create_string_accessor),add_type(number_regexp,create_number_accessor),add_type(/.*/,create_lookup);
