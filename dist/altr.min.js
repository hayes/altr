...
function create_element_node(t){var e,a={},n=this,r={el:t,update_children:this.update_children,hooks:[]},l=Array.prototype.filter.call(t.attributes,function(t){return n.tags[t.name]?(a[t.name]=t.value)&&!1:!0});l.forEach(function(e){var a=n.template_string(e.value,function(a){t.setAttribute(e.name,a)});a&&r.hooks.push(n.batch.add(a))});for(var o=0,i=n.tag_list.length;i>o;++o)e=a[n.tag_list[o].attr],e&&n.tag_list[o].constructor.call(n,r,e);return r.children=[].map.call(t.childNodes,n.create_node.bind(n)).filter(Boolean),r.children.length||r.hooks.length?r:void 0}module.exports=create_element_node;
...
function template_string(t,n){function e(t,e){h[t]=e,n(h.join(""))}function i(t){o.forEach(function(n){n(t)})}if(t.match(TAG)){for(var s,c,r=t,h=[],o=[];r&&(c=r.match(TAG));)(s=r.indexOf(c[0]))&&h.push(r.slice(0,s)),h.push(""),r=r.slice(s+c[0].length),o.push(this.create_accessor(c[1],e.bind(this,h.length-1)));return i}}var TAG=/{{\s*(.*?)\s*}}/;module.exports=template_string;
