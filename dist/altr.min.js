...
function for_handler(e,r){function n(e){for(var r,n=0,t=f.length;t>n;++n)r=Object.create(e),r[p]=u[n],r.$index=n,f[n].update&&f[n].update(r)}function t(e,r){Array.isArray(e)||(e=[]);var t,a=new Array(e.length);d=[];for(var l=0,c=e.length;c>l;++l)t=i(u,e[l],h),-1!==t?(a[l]=f.splice(t,1)[0],u.splice(t,1)):a[l]=o(),d=d.concat(a[l].dom_nodes);f=a.slice(),u=e.slice(),g(),n(r)}function i(e,r,n){if(!n)return e.indexOf(r);for(var t=0,i=e.length;i>t;++t)if(e[t][n]===r[n])return t;return-1}function o(){var r,n,t=s.document.createElementNS(e.namespaceURI,"div");return t.innerHTML=c,r=Array.prototype.slice.call(t.childNodes),n=s.updateNodes(r),{dom_nodes:r,update:n}}function a(){for(var r,n=null,t=d.length-1;t>=0;--t)r=s.getElement(d[t]),(n&&r.nextSibling!==n||r.parentNode!==e)&&e.insertBefore(r,n),n=r;for(;e.firstChild!==n;)e.removeChild(e.firstChild)}var l=r.match(for_regexp),c=e.innerHTML,d=[],f=[],s=this,u=[];if(!l)throw new Error("invalid for tag: "+r);e.innerHTML="";var h=l[1].split(":")[1],p=l[1].split(":")[0],v=l[2],g=this.batch.add(a);return s.createAccessor(v,t)}var for_regexp=/^(.*?)\s+in\s+(.*$)/;module.exports=for_handler;
