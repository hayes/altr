...
function for_handler(e,n){function r(n){function r(n){for(var r=0,o=n.length;o>r;++r)e.el.insertBefore(n[r],c)}Array.isArray(n)||(n=[]);var l,t,a=new Array(n.length),c=e.el.firstChild,s=0;e.children=[];for(var h=0,f=n.length;f>h;++h)l=i.indexOf(n[h]),-1!==l?(a[h]=d.splice(l,1)[0],i.splice(l,1),l+s!==h&&r(a[h].dom_nodes),++s):(a[h]=o(),r(a[h].dom_nodes),++s),t=a[h].dom_nodes,c=t.length?t[t.length-1].nextSibling:null,t=t.concat(a[h].dom_nodes),e.children=e.children.concat(a[h].altr_nodes);for(var h=0,f=d.length;f>h;++h)d[h].dom_nodes.forEach(function(e){e.parentNode.removeChild(e)});d=a.slice(),i=n.slice()}function o(){var n,r,o=a.document.createElementNS(e.el.namespaceURI,"div");return o.innerHTML=t,r=Array.prototype.slice.call(o.childNodes),n=r.map(a.create_node.bind(a)).filter(Boolean),{dom_nodes:r,altr_nodes:n}}var l=n.match(for_regexp),t=e.el.innerHTML,d=[],a=this,i=[];if(!l)throw new Error("invalid for tag: "+n);e.el.innerHTML="";var c=l[1],s=l[2];e.hooks.push(a.create_accessor(s,a.batch.add(r))),e.update_children=function(n){for(var r,o=0,l=e.children.length;l>o;++o)r=Object.create(n),r[c]=i[o],r.$index=o,a.update(r,e.children[o])}}var for_regexp=/^(.*?)\s+in\s+(.*$)/;module.exports=for_handler;
