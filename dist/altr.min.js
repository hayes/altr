...
function create_element_node(t){var e,a={},r=this,l={el:t,update_children:this.update_children,hooks:[]},n=Array.prototype.filter.call(t.attributes,function(t){return r.tags[t.name]?(a[t.name]=t.value)&&!1:!0});n.forEach(function(e){var a=e.name.indexOf("altr-attr-")?e.name:e.name.slice("altr-attr-".length),n=r.template_string(e.value,function(e){t.setAttribute(a,e)});n&&l.hooks.push(r.batch.add(n))});for(var o=0,i=r.tag_list.length;i>o;++o)e=a[r.tag_list[o].attr],e&&r.tag_list[o].constructor.call(r,l,e);return l.children=[].map.call(Array.prototype.slice.call(t.childNodes),r.create_node.bind(r)).filter(Boolean),l.children.length||l.hooks.length?l:void 0}module.exports=create_element_node;
...
function for_handler(e,n){function r(n){for(var r,o=0,t=e.children.length;t>o;++o)r=Object.create(n),r[h]=s[o],r.$index=o,c.update(r,e.children[o])}function o(n,o){function l(n){for(var r=0,o=n.length;o>r;++r)e.el.insertBefore(n[r],u)}Array.isArray(n)||(n=[]);var a,c,h=new Array(n.length),u=e.el.firstChild,p=0;e.children=[];for(var _=0,m=n.length;m>_;++_)a=t(s,n[_],f),-1!==a?(h[_]=d.splice(a,1)[0],s.splice(a,1),a+p!==_&&l(h[_].dom_nodes),++p):(h[_]=i(),l(h[_].dom_nodes),++p),c=h[_].dom_nodes,u=c.length?c[c.length-1].nextSibling:null,c=c.concat(h[_].dom_nodes),e.children=e.children.concat(h[_].altr_nodes);for(var _=0,m=d.length;m>_;++_)d[_].dom_nodes.forEach(function(e){e.parentNode.removeChild(e)});d=h.slice(),s=n.slice(),r(o)}function t(e,n,r){if(!r)return e.indexOf(n);for(var o=0,t=e.length;t>o;++o)if(e[o][r]===n[r])return o;return-1}function i(){var n,r,o=c.document.createElementNS(e.el.namespaceURI,"div");return o.innerHTML=a,r=Array.prototype.slice.call(o.childNodes),n=r.map(c.create_node.bind(c)).filter(Boolean),{dom_nodes:r,altr_nodes:n}}var l=n.match(for_regexp),a=e.el.innerHTML,d=[],c=this,s=[];if(!l)throw new Error("invalid for tag: "+n);e.el.innerHTML="";var f=l[1].split(":")[1],h=l[1].split(":")[0],u=l[2];e.hooks.push(c.create_accessor(u,c.batch.add(o))),e.update_children=function(){}}var for_regexp=/^(.*?)\s+in\s+(.*$)/;module.exports=for_handler;
